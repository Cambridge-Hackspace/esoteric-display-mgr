defmodule EsotericDisplayMgrWeb.UserAuthTest do
  use EsotericDisplayMgrWeb.ConnCase

  alias Phoenix.LiveView
  alias EsotericDisplayMgr.Accounts
  alias EsotericDisplayMgr.Accounts.Scope
  alias EsotericDisplayMgrWeb.UserAuth

  import EsotericDisplayMgr.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EsotericDisplayMgrWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      EsotericDisplayMgrWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "disconnect_sessions/1" do
    test "broadcasts disconnect messages for each token" do
      ...
      for %{token: token} <- tokens do
        EsotericDisplayMgrWeb.Endpoint.subscribe("users_sessions:#{Base.url_encode64(token)}")
      end
